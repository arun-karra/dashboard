...
# --- Merge Forms by Assessment ID (include ReviewComment if present) ---
...
r2c3.metric("Open Action Required",     open_actions);  r2c3.caption("QC flags unresolved.")
r2c4.metric("Forms Late (>5d)",         late_forms);    r2c4.caption("Forms >5 days post-upload.")
...
def out_of_window(r):
    name = r[s_assess]
    if "week 4" in name.lower():
        tol, offset = 10, 28
    elif "month 6" in name.lower():
        tol, offset = 14, 182
    else:
        return False
